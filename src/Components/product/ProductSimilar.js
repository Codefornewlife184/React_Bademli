                ...
                <div className="ali-img-wrap">
                  <div>
                    <img
                      ...
                      src="assets/images/products/armür-1.webp"
                      alt="image"
                      title="image"
                    />
                  </div>
            ...
            <div className="">
              <Link className="ali-link" onClick={handleClick} as={Link} to="/Fonluk">
                ...
                <div>
                    <img
                      className="img-fluid blur-up lazyload"
                      src="assets/images/products/fon-1.webp"
                      alt="image"
                      title="image"
                    />
                  </div>
            ...
            <div className="album-list-item">
              <Link className="ali-link" onClick={handleClick} as={Link} to="/Brode">
                ...
                <div>
                    <img
                      className="img-fluid blur-up lazyload"
                      src="assets/images/products/brode-2.webp"
                      alt="image"
                      title="image"
                    />
                  </div>
            ...
            <div className="album-list-item">
              <Link className="ali-link" onClick={handleClick} as={Link} to="/Nakis">
                ...
                <div>
                    <img
                      className="img-fluid blur-up lazyload"
                      src="assets/images/products/nakış-1.webp"
                      alt="image"
                      title="image"
                    />
                  </div>
            ...
            <div className="album-list-item">
              <Link className="ali-link" onClick={handleClick} as={Link} to="/Orme">
                ...
                <div>
                    <img
                      className="img-fluid blur-up lazyload"
                      src="assets/images/products/örme-1.webp"
                      alt="image"
                      title="image"
                    />
                  </div>
            ...
            <div className="album-list-item">
              <Link className="ali-link" onClick={handleClick} as={Link} to="/Baskili">
                ...
                <div>
                    <img
                      className="img-fluid blur-up lazyload"
                      src="assets/images/products/baski-4.webp"
                      alt="image"
                      title="image"
                    />
                  </div>
